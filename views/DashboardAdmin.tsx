...
export const DashboardAdmin: React.FC<Props> = ({
    ...
    const beltColors = useMemo(() => {
        ...
        const pontaPart = rest.join('ponta'); // In case there are multiple 'ponta' (unlikely)
